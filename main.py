...
Cr1 = Cave("CR1")
Cr1.set_description("Computer room")
Book = Cave("Libary")
Book.set_description("The Libary")
senior = Cave("Senior area")
senior.set_description("Senior area")
Lab = Cave("Science rooms")
Lab.set_description("Science rooms where sciency stuff happens")
